...
url = "https://www.espncricinfo.com/records/season/team-match-results/2023to24-2023to24?trophy=12"
...
df.to_csv('ODI_result_2024.csv', index=False)
print("ODI_result_2024.csv")
