...
url = "Https://www.espncricinfo.com/records/season/team-match-results/2021-2021?trophy=117"
...
df.to_csv('ipl_result_2021.csv', index=False)
print("Data saved to ipl_result_2021.csv")
