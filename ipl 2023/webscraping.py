...
url = "https://www.espncricinfo.com/records/season/team-match-results/2023-2023?trophy=117"
...
df.to_csv('ipl_result_2023.csv', index=False)
print("Data saved to ipl_result_2023.csv")
